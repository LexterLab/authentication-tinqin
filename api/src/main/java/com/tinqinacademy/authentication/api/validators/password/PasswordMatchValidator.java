...
public class PasswordMatchValidator implements ConstraintValidator<PasswordValueUnique, Object> {
    private String field;
    private String fieldMatch;
    private String message;
    @Override
    public void initialize(PasswordValueUnique constraintAnnotation) {
